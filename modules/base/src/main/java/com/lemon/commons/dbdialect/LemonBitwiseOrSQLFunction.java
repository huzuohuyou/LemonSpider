...
public class LemonBitwiseOrSQLFunction extends StandardSQLFunction {
	public LemonBitwiseOrSQLFunction(String name) {
		super(name, org.hibernate.type.IntegerType.INSTANCE);
	}

	public LemonBitwiseOrSQLFunction(String name, Type typeValue) {
