...
public class LemonBitwiseAndSQLFunction extends StandardSQLFunction {
	public LemonBitwiseAndSQLFunction(String name) {
		super(name, org.hibernate.type.IntegerType.INSTANCE);
	}

	public LemonBitwiseAndSQLFunction(String name, Type typeValue) {
